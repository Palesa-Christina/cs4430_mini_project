...
insert into PATIENT values (1, 'Limpho', 'Male', 'Maseru' ,'0123', 23);
insert into PATIENT values (2, 'Thabo', 'Male', 'Semonkong', '0179', 27);
select * from PATIENT;
...
insert into DOCTOR values (2, 'Palesa', 'MBBS', 100000, 'Uttara', '676767766');
